...
export default class SpriteFactory {
  ...
  createUnitSprite = async (spriteName: string, paletteSwaps: PaletteSwaps): Promise<DynamicSprite<Unit>> => {
    ...
    const imageMap = await this._loadAnimations(SpriteCategory.UNITS, model, paletteSwaps);
  ...
  createEquipmentSprite = async (spriteName: string, paletteSwaps: PaletteSwaps) => {
    ...
    const imageMap = await this._loadAnimations(SpriteCategory.EQUIPMENT, model, paletteSwaps);
