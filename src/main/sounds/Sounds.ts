const Sounds: {[key: string]: [number, number][]} = {
  ...
  ENEMY_DIES: [[20,20],[0,10],[30,20],[0,10],[25,20],[0,10],[25,20],[0,5],[40,20],[0,5],[35,20],[0,5],[45,20],[0,5],[25,20],[0,10],[35,20],[0,10],[25,20],[0,10],[30,20],[0,20],[40,10],[0,20],[35,10],[0,20],[45,10],[0,20],[25,5],[0,30],[35,5],[0,30],[20,5],[0,30],[30,5]], // TODO make Will make one!
